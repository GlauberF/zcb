...
exports.ListarClientesController = void 0;
const utils_1 = require("../../utils/utils");
const errors_1 = require("../../utils/errors");
const response_1 = require("../../utils/response");
const listar_clientes_usecase_1 = require("./listar-clientes.usecase");
class ListarClientesController {
    ...
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const useCase = new listar_clientes_usecase_1.ListarClientesUsecase();
...
exports.ListarClientesController = ListarClientesController;
