...
exports.DeletarClientesController = void 0;
const utils_1 = require("../../utils/utils");
const errors_1 = require("../../utils/errors");
const response_1 = require("../../utils/response");
const deletar_clientes_usecase_1 = require("./deletar-clientes.usecase");
class DeletarClientesController {
    ...
    handle(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const useCase = new deletar_clientes_usecase_1.DeletarClientesUsecase();
            try {
...
exports.DeletarClientesController = DeletarClientesController;
