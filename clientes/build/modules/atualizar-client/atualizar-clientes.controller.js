...
exports.AtualizarClientesController = void 0;
const utils_1 = require("../../utils/utils");
const errors_1 = require("../../utils/errors");
const response_1 = require("../../utils/response");
const atualizar_clientes_usecase_1 = require("./atualizar-clientes.usecase");
class AtualizarClientesController {
    constructor() {
    }
    handle(req, res) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const useCase = new atualizar_clientes_usecase_1.AtualizarClientesUsecase();
            try {
...
exports.AtualizarClientesController = AtualizarClientesController;
