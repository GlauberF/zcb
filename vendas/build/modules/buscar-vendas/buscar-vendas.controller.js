...
exports.BuscarVendasController = void 0;
const utils_1 = require("../../utils/utils");
const errors_1 = require("../../utils/errors");
const response_1 = require("../../utils/response");
const buscar_vendas_usecase_1 = require("./buscar-vendas.usecase");
class BuscarVendasController {
    constructor() {
    }
    handle(req, res) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const useCase = new buscar_vendas_usecase_1.BuscarVendasUsecase();
            try {
...
exports.BuscarVendasController = BuscarVendasController;
