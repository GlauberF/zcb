...
class BuscarVendasUsecase {
    ...
    execute(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return prismaClient_1.prismaClient.vendas.findUnique({
                where: {
                    id,
...
exports.BuscarVendasUsecase = BuscarVendasUsecase;
