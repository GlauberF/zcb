...
exports.AtualizarProdutosController = void 0;
const utils_1 = require("../../utils/utils");
const errors_1 = require("../../utils/errors");
const response_1 = require("../../utils/response");
const atualizar_produtos_usecase_1 = require("./atualizar-produtos.usecase");
class AtualizarProdutosController {
    ...
    handle(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const useCase = new atualizar_produtos_usecase_1.AtualizarProdutosUsecase();
            try {
...
exports.AtualizarProdutosController = AtualizarProdutosController;
