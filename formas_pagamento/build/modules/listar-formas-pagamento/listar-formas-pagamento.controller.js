...
exports.ListarFormasPagamentoController = void 0;
const utils_1 = require("../../utils/utils");
const errors_1 = require("../../utils/errors");
const response_1 = require("../../utils/response");
const listar_formas_pagamento_usecase_1 = require("./listar-formas-pagamento.usecase");
class ListarFormasPagamentoController {
    ...
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const useCase = new listar_formas_pagamento_usecase_1.ListarFormasPagamentoUsecase();
...
exports.ListarFormasPagamentoController = ListarFormasPagamentoController;
