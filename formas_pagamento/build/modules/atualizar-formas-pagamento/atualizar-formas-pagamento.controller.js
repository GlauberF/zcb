...
exports.AtualizarFormasPagamentoController = void 0;
const utils_1 = require("../../utils/utils");
const errors_1 = require("../../utils/errors");
const response_1 = require("../../utils/response");
const atualizar_formas_pagamento_usecase_1 = require("./atualizar-formas-pagamento.usecase");
class AtualizarFormasPagamentoController {
    constructor() {
    }
    handle(req, res) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const useCase = new atualizar_formas_pagamento_usecase_1.AtualizarFormasPagamentoUsecase();
            try {
...
exports.AtualizarFormasPagamentoController = AtualizarFormasPagamentoController;
