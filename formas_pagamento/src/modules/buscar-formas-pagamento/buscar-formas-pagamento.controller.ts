...
import {BuscarFormasPagamentoUsecase} from "./buscar-formas-pagamento.usecase";

export class BuscarFormasPagamentoController {
    constructor() {
    }

    async handle(req: any, res: any) {
        const id = extractId(req.url) ?? '';
        const useCase = new BuscarFormasPagamentoUsecase();
