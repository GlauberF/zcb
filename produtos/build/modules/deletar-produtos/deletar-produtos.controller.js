...
exports.DeletarProdutosController = void 0;
const utils_1 = require("../../utils/utils");
const errors_1 = require("../../utils/errors");
const response_1 = require("../../utils/response");
const deletar_produtos_usecase_1 = require("./deletar-produtos.usecase");
class DeletarProdutosController {
    ...
    handle(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const useCase = new deletar_produtos_usecase_1.DeletarProdutosUsecase();
            try {
...
exports.DeletarProdutosController = DeletarProdutosController;
