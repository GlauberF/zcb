...
exports.BuscarProdutosController = void 0;
const utils_1 = require("../../utils/utils");
const errors_1 = require("../../utils/errors");
const response_1 = require("../../utils/response");
const buscar_produtos_usecase_1 = require("./buscar-produtos.usecase");
class BuscarProdutosController {
    ...
    handle(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const useCase = new buscar_produtos_usecase_1.BuscarProdutosUsecase();
            try {
...
exports.BuscarProdutosController = BuscarProdutosController;
