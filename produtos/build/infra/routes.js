...
const criar_produtos_controller_1 = require("../modules/create-produtos/criar-produtos.controller");
...
const listar_produtos_controller_1 = require("../modules/listar-produtos/listar-produtos.controller");
const routes = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((!id || Object.keys(queryParams).length) && req.method === 'GET') {
        return new listar_produtos_controller_1.ListarProdutosController().handle(req, res);
    }
    else if (id && req.method === 'GET') {
        return new buscar_produtos_controller_1.BuscarProdutosController().handle(req, res);
    }
    else if (req.url === '/' && req.method === 'POST') {
        return new criar_produtos_controller_1.CriarProdutosController().handle(req, res);
    }
